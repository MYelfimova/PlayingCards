...
class PlayingCardView: UIView {
    ...
    private func centeredAtttibutedString(_ string:String, fontSize: CGFloat) -> NSAttributedString {
    ...
    private var cornerString: NSAttributedString {
        return centeredAtttibutedString("\(rankString)\n\(suit)" , fontSize: cornerFontSize)
    }
    ...
    //if landscape.. or any other screen setting changes, i'm redrawing al thef view
